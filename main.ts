...
function placeDoughZone4() {
    dough1 = sprites.create(img`
        ...
        f c c d c c c c c f e e e e f c
    `, SpriteKind.dough)
    tiles.placeOnTile(dough1, tiles.getTileLocation(19, 4))
    ...
    `, SpriteKind.dough)
    tiles.placeOnTile(dough2, tiles.getTileLocation(20, 4))
    dough3 = sprites.create(img`
        ...
        . . . f f f f f . . . . . . . .
    `, SpriteKind.dough)
    tiles.placeOnTile(dough3, tiles.getTileLocation(19, 5))
    dough4 = sprites.create(img`
        ...
        . . . . . . . . . f f f f . . .
    `, SpriteKind.dough)
    tiles.placeOnTile(dough4, tiles.getTileLocation(20, 5))
}
function placeDoughZone5() {
    dough1 = sprites.create(img`
        ...
        f c c d c c c c c f e e e e f c
    `, SpriteKind.dough)
    tiles.placeOnTile(dough1, tiles.getTileLocation(19, 7))
    dough2 = sprites.create(img`
        f f f f f f f f f f f f f f . .
        c c c c c c c c c c c c c f b .
        d d d d d d d d d d d d c f f f
        ...
        c 1 d 1 1 c c c c c c c d c c f
    `, SpriteKind.dough)
    tiles.placeOnTile(dough2, tiles.getTileLocation(20, 7))
    dough3 = sprites.create(img`
        f c c d c c c c c c f e e f c c
        f c c d c c c c c c f e e f c c
        f c c d c c c c c c f e e f c c
        ...
        . . . f f f f f . . . . . . . .
    `, SpriteKind.dough)
    tiles.placeOnTile(dough3, tiles.getTileLocation(19, 8))
    dough4 = sprites.create(img`
        c c c c c c c c c c c c d c c f
        c c c c c c c c c c c c d c c f
        c c c c c c c c c c c c d c c f
        ...
        . . . . . . . . . f f f f . . .
    `, SpriteKind.dough)
    tiles.placeOnTile(dough4, tiles.getTileLocation(20, 8))
}
